...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> RESPAWN_NAGA = registryBlock("respawn_naga",
            () -> new RespawnBlockNaga(BlockBehaviour.Properties.copy(Blocks.BEDROCK)));
    public static final RegistryObject<Block> RESPAWN_LICH = registryBlock("respawn_lich",
            () -> new RespawnBlockLich(BlockBehaviour.Properties.copy(Blocks.BEDROCK)));
    public static final RegistryObject<Block> RESPAWN_HYDRA = registryBlock("respawn_hydra",
            () -> new RespawnBlockHydra(BlockBehaviour.Properties.copy(Blocks.BEDROCK)));
    public static final RegistryObject<Block> RESPAWN_UR_GHAST = registryBlock("respawn_ur_ghast",
            () -> new RespawnBlockUrGhast(BlockBehaviour.Properties.copy(Blocks.BEDROCK)));
    public static final RegistryObject<Block> RESPAWN_SNOW_QUEEN = registryBlock("respawn_snow_queen",
