...
public class SpawnhydraProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		central = ForgeRegistries.BLOCKS.getValue(new ResourceLocation("twilightforest:hydra_trophy")).defaultBlockState();
		ring = ForgeRegistries.BLOCKS.getValue(new ResourceLocation("minecraft:ancient_debris")).defaultBlockState();
		F = 0;
		...
		if (F == 9) {
			...
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.FLAME, (x + 3), y, z, 20, 0, 0, 0, 1);
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.FLAME, (x - 3), y, z, 20, 0, 0, 0, 1);
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.FLAME, x, y, (z + 3), 20, 0, 0, 0, 1);
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.FLAME, x, y, (z - 3), 20, 0, 0, 0, 1);
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.FLAME, (x + 2), y, (z + 2), 20, 0, 0, 0, 1);
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.FLAME, (x + 2), y, (z - 2), 20, 0, 0, 0, 1);
			if (world instanceof ServerLevel _level)
				_level.sendParticles(ParticleTypes.FLAME, (x - 2), y, (z + 2), 20, 0, 0, 0, 1);
