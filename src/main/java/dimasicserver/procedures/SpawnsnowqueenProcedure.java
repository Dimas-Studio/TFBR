...
public class SpawnsnowqueenProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity) {
		...
		central = BuiltInRegistries.BLOCK.get(new ResourceLocation(ConfigConfiguration.SQ_TROPHY_BLOCK.get())).defaultBlockState();
		ring = BuiltInRegistries.BLOCK.get(new ResourceLocation(ConfigConfiguration.SQ_RING_BLOCK.get())).defaultBlockState();
		F = 0;
		...
		if (F == 9) {
			...
			if (world instanceof Level _level) {
				if (!_level.isClientSide()) {
					_level.playSound(null, BlockPos.containing(x, y, z), BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("block.snow.break")), SoundSource.HOSTILE, 3, 3);
				} else {
					_level.playLocalSound(x, y, z, BuiltInRegistries.SOUND_EVENT.get(new ResourceLocation("block.snow.break")), SoundSource.HOSTILE, 3, 3, false);
				}
			}
