...
public class DimasicServerModBlocks {
	...
	public static class ClientSideHandler {
		...
		public static void clientSetup(FMLClientSetupEvent event) {
			SabudkaBlock.registerRenderLayer();
			MoonBlock.registerRenderLayer();
			NagarespawnBlock.registerRenderLayer();
			LichspawnBlock.registerRenderLayer();
			HydraspawnBlock.registerRenderLayer();
			UrGhastspawnBlock.registerRenderLayer();
			SnowqueenspawnBlock.registerRenderLayer();
		}
	}
}
