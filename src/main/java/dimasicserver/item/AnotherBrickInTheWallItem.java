...
public class AnotherBrickInTheWallItem extends RecordItem {
	public AnotherBrickInTheWallItem() {
		super(0, DimasicServerModSounds.REGISTRY.get(new ResourceLocation("dimasic_server:another_brick_in_the_wall")),
				new Item.Properties().tab(DimasicServerModTabs.TAB_SERVER_STUFF).stacksTo(1).rarity(Rarity.RARE));
	}
}
