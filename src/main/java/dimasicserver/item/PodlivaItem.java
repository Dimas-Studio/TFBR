...
public class PodlivaItem extends DimasicServerModElements.ModElement {
	@ObjectHolder("dimasic_server:podliva")
	public static final Item block = null;

	public PodlivaItem(DimasicServerModElements instance) {
		super(instance, 2);
	}
